...
export default function ChangeProfile({navigation}) {
    return(
        <View  style= {{width: "100%", height: "100%", backgroundColor: "#26282c"}}>
            ...
            <Ionicons onPress={()=>navigation.navigate("Home")} name='arrow-back' style= {{fontSize: 22, color: "#FDD130", marginTop:48,paddingLeft:10}}></Ionicons>
            <Text style= {{color: "white", marginLeft: "2%", fontWeight: "bold",fontSize: 18,marginTop:48, paddingBottom: 12}}>Edit Profile</Text>
        </View>
        <View>
